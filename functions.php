 ...
 */
function hamburger_cat_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'hamburger-cat' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'hamburger-cat' ),
...
add_action( 'widgets_init', 'hamburger_cat_widgets_init' );
