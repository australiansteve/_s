									...
									<div class="grid-y align-center">
										<div class="cell text-center">
											<ul class="menu vertical nested">
												...
												if (has_nav_menu('off-canvas-account-login-menu')) {
													wp_nav_menu(
														array(
															'theme_location' => 'off-canvas-account-login-menu',
															'container'		=> false,
															'items_wrap' => '%3$s'
														)
													);
								...
								<nav id="site-navigation" class="main-navigation medium-text-right">
									...
									<div id="menus">
										...
										if ($menuType == 'top-right') {
											...
											?>
											<div class="menu-site-functions text-right">
												<?php //echo get_search_form();?>

												<?php

												if (has_nav_menu('account-login-menu')) {
													wp_nav_menu(
														array(
															'theme_location' => 'account-login-menu',
