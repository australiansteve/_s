...
if ( $postsquery->have_posts() ) {
	while ( $postsquery->have_posts() ) {
		...
		?>
		<a class="button" href="<?php echo get_post_permalink($wishlist_id);?>" target="_blank" onclick="return view_wishlist(<?php echo $wishlist_id;?>)"><?php echo sprintf(__('View Wishlist', 'hamburger-cat')); ?></a>
		<?php
	}
